...
We found that the p-value is less than 0.05, we reject the null hypothesis and conclude that there is a significant difference in mean density concentration between red and white wine.
...
We found that the p-value is less than 0.05, we reject the null hypothesis and conclude that there is a significant difference in mean chloride concentration between red and white wine.
...
We found that the p-value is less than 0.05, we reject the null hypothesis and conclude that there is a significant difference in mean citric acid concentration between red and white wine.
