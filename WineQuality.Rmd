...
model1 = lm(quality ~ ., data=numeric_data)
...
# Load your dataset (assuming 'wine_data' is your data frame)
...
wine_tree <- rpart(quality ~ ., data = train_data, method = "class", control = control)
...
plot(roc_curve, col = "black", main = "ROC Curve for Random Forest Model",
     col.main = "black", lwd = 2, cex.main = 1.2)

# Add diagonal reference line for comparison
abline(a = 0, b = 1, lty = 2, col = "red")

# Print the AUC (Area Under the Curve)
cat("AUC:", round(auc(roc_curve), 4), "\n")
