...
To understand in depth as to which factor effects the quality the most, let's look at the individual variables in the data set.
...
The boxplot shows that wines with higher quality seem to have a less denser. Let us check how it varies for red and white wine

```{r alcqual3, results='asis'}
...
The boxplot shows that wines with higher quality seem to have a less chlorides. Let us check how it varies for red and white wine
...
The boxplot shows that wines with higher quality seem to have a high citric acid Let us check how it varies for red and white wine
